...
# Cities
cities = ["lahore", "karachi", "multan", "peshawar", "Swaat", "Gilgit", "Quetta", "Rahim Yar Khan","fsd","malakand"]

distances = [
    [0,  60, 100,     510,    620,    40,  70,    80,     120,     650 ] , 
     [60, 0,  60,      130,    40,     80,  90,    90,     440,     540 ] , 
      [100,60, 0,       450,    450,    860, 910,   190,    10,      145 ] , 
        [510,130 ,450,   0,       70,     1500, 440,   220,   660,     250] , 
          ...
          [120,440,10,     660,     120,     350,  150,  330,    0,      330], 
